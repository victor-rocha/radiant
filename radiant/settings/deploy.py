...
DATABASES['default']['NAME'] = 'radiant_%s' % ENVIRONMENT.lower()
DATABASES['default']['USER'] = 'radiant_%s' % ENVIRONMENT.lower()
DATABASES['default']['HOST'] = os.environ.get('DB_HOST', '')
DATABASES['default']['PORT'] = os.environ.get('DB_PORT', '')
DATABASES['default']['PASSWORD'] = os.environ.get('DB_PASSWORD', '')

WEBSERVER_ROOT = '/var/www/radiant/'
...
# BROKER_URL = 'amqp://radiant_%(ENVIRONMENT)s:%(BROKER_PASSWORD)s@%(BROKER_HOST)s/radiant_%(ENVIRONMENT)s' % os.environ  # noqa
