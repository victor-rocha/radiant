...
(function () {
    ...
    function Carousel3dService($rootScope, $q, $log) {
        ...
        function Carousel3d(slides, params) {
            ...
            this.border = (params.border !== 'undefined') ? params.border : 5;
        ...
        function setSlides() {
            ...
            for (var m = 1; m < num; m++) {
                ...
                console.log('eq1 is ' + eq1);
                console.log('eq2 is ' + eq2);

                this.leftSlides.push(eq1);
                this.rightSlides.push(eq2);
            }
            console.log('left slides >>>>>>>>>>>');
            console.log(this.leftSlides);
            console.log('>>>>>>>>>>>>>>>>>>>>>');

            console.log('right slides >>>>>>>>>>>');
            console.log(this.rightSlides);
            console.log('>>>>>>>>>>>>>>>>>>>>>');
